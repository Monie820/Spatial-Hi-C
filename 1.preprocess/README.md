...
5. Generate configuration file for Higashi Running by [pre_higashi_GPU_3.sh](https://github.com/Monie520/Spatial-Hi-C/blob/main/1.preprocess/pre_higashi_GPU_3.sh).
